        ...
        <div className="container">
          <div className="contact__section">
            <div className="contact__info">
              ...
              <p>
                {" "}
                <i className="fa-solid fa-phone-square-alt icon"></i> +92 347
                3460945
              </p>
              <div className="social__icons">
                ...
                <a href="https://www.facebook.com/armghanmehmood/">
                  <i className="fab fa-facebook-f"></i>
                </a>
                <a href="https://www.instagram.com/armghansphotography/">
                  <i className="fab fa-instagram"></i>
                </a>
                <a href="https://www.linkedin.com/in/armghan-mehmood-b06581279/">
